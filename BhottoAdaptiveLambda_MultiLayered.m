function [H1_hat,e,e_f,Lambda,LAYERS] = BhottoAdaptiveLambda_MultiLayered(x1,d,N0,M1,delta,lambda_max,Max_Layers,Input_mode)
...
%     % Adaptive forgetting factor at RLS#>1
        if Lambda_Adaptivity == 1
            ...
            %                               and it is calculated based on Paleologu/Bhotto method             
                        ...
                        % Bhotto Method 
                        [lambda_f{c},sigma_k_f{c}] = Adaptive_Forget_Factor_Bhotto(e_f{c}(l),sigma_k_f{c},N0,M1);
